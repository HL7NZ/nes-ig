...
<tr><td> https://api.hip.digital.health.nz/fhir/system/Coverage.r </td><td> Read access to all active patient entitlements </td></tr>
<tr><td> https://api.hip.digital.health.nz/fhir/system/Coverage.s </td><td> Search access to all active patient entitlementss </td></tr>
<tr><td> https://api.hip.digital.health.nz/fhir/system/Coverage.u </td><td> Update access to all active patient entitlements </td></tr>
<tr><td> https://api.hip.digital.health.nz/fhir/system/Coverage.c </td><td> Create access to all active patient entitlements </td></tr>
<tr><td> https://api.hip.digital.health.nz/fhir/system/Coverage.a </td><td> Admin access to all active patient entitlements </td></tr>
</table>

* Access to view a Patients entitlements history is an additional permissions that should be requested during the onboarding process
